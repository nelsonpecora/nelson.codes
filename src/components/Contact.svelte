  ...
  const socials = [
    {
      ...
      items: [
        ...
        },
        {
          icon: faTwitter,
          alt: 'twitter',
          title: 'nelsonpecora (archive)',
          url: 'https://tweet.nelson.codes',
        },
      ],
    },
    {
...
<Wrapper theme="grey">
  ...
  <webring-banner class="webring">
    <p>
      Member of the <a href="https://web.mainframe.club">Mainframe.club</a> webring
    </p>
